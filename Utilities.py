...
def gerar_inimigo_aleatorio():
    ...
    Correction: mesmo erro de antes, pegou o module, tem q pegar a classe que está dentro do module."""
    return Inimigo.Inimigo(escolhido["nome"], escolhido["hp"], escolhido["vel"], escolhido["dmin"], escolhido["dmax"])
